				...
				switch(choice){
					...
					case 7:
						...
						for(Student student_1 : listStudent_1){
							System.out.println(""+ i + "." + student_1.name);
							i++;
						}
						System.out.println("Please choice student want to search by name");
						String nameStudent = input.readLine();
						nameStudent = nameStudent.toLowerCase();
						List<DetailMarkTable> listDetail = gcs.getM_MarkTable().getList();
						boolean flag = false;
						for(DetailMarkTable detailMarkTable : listDetail){
							String nameDemo = detailMarkTable.getM_Student().getName();
							nameDemo = nameDemo.toLowerCase();
							if(nameDemo.equals(nameStudent)){
								System.out.println(detailMarkTable.getM_Student().toString());
								System.out.println(detailMarkTable.getM_Subject().toString());
								double practice = detailMarkTable.getM_FinalGrade().getM_MarkExam().getMarkPractice();
								double multichoice = detailMarkTable.getM_FinalGrade().getM_MarkExam().getMarkMultiChoice();
								System.out.println("Mark of practice: " + practice);
								System.out.println("Mark of multichoice: " + multichoice);
								List<MarkSession> listSession = detailMarkTable.getM_FinalGrade().getList();
								int j = 1;
								for(MarkSession markSession : listSession){
									System.out.println();
									System.out.println("Session " + i);
								...
								System.out.println();
								System.out.println("Total mark: " + detailMarkTable.getM_FinalGrade().calFinalGrade());
								System.out.println("============================================");
								flag = true;
							}
						...
						if(flag == false){
							System.out.println("do not have student in class");
						}
						break;
					...
					case 8:
						...
						for(Subject subject : listSubjects){
							System.out.println(""+ k + "." + subject.getNameOfSubject());
							k++;
						}
						System.out.println("Please input name of subject want to search");
						String nameSubject = input.readLine();
						nameSubject = nameSubject.toLowerCase();
						List<DetailMarkTable> listDetail1 = gcs.getM_MarkTable().getList();
						boolean flag1 = false;
						for(DetailMarkTable detailMarkTable : listDetail1){
							String subjectDemo = detailMarkTable.getM_Subject().getNameOfSubject();
							subjectDemo = subjectDemo.toLowerCase();
							if(subjectDemo.equals(nameSubject)){
								System.out.println(detailMarkTable.getM_Student().toString());
								System.out.println(detailMarkTable.getM_Subject().toString());
								double practice = detailMarkTable.getM_FinalGrade().getM_MarkExam().getMarkPractice();
								double multichoice = detailMarkTable.getM_FinalGrade().getM_MarkExam().getMarkMultiChoice();
						...
						if(flag1 == false){
							System.out.println("do not have subject in class");
						}
						break;
