	...
	public static void main(String[] args) {
		...
		try {
					...
					case 2:
						...
						switch (choiceTypeMoney) {
							case 1:
								...
								listMoney = Arrays.copyOf(listMoney, listMoney.length + 1);
			...
			if(listGold.length > 0){
				...
				System.out.println("Average money for gold: "+ (total / sizeGold));
			}
			if(listMoney.length > 0){
				...
				System.out.println("Average money for sell: " + (totalMoneySell / sizeMoneySell));
				System.out.println("Average money for buy: " + (totalMoneyBuy / sizeMoneyBuy));
			}
